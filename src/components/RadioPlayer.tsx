...
const RadioPlayer = ({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 w-full bg-gradient-to-br from-purple-900/95 via-violet-800/95 to-indigo-900/95 backdrop-blur-xl border-t border-white/10 shadow-2xl">
      <div className="container mx-auto px-3 py-4 sm:px-6 sm:py-6 max-w-none">
        ...
        <div className="text-center mb-4 sm:mb-8 relative z-10">
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-1 sm:mb-2 drop-shadow-lg">
            Radio Noumi
          </h2>
        ...
        <div className="flex items-center space-x-2 sm:space-x-4 mb-4 sm:mb-6 relative z-10">
          <Icon
            name="Volume2"
          ...
          <span className="text-xs sm:text-sm text-white/70 w-8 sm:w-10 text-right">
            {Math.round(volume * 100)}%
          </span>
        </div>

        {/* Статистика */}
        <div className="flex justify-between items-center text-xs sm:text-sm text-white/60 relative z-10">
