...
const AdBanner = () => {
  return (
    <div className="w-full h-[80px] sm:h-[100px] md:h-[120px] lg:h-[130px] px-2 sm:px-4 md:px-6 lg:px-8">
      <div className="w-full h-full bg-gradient-to-r from-purple-600 via-pink-500 to-indigo-600 rounded-none sm:rounded-lg shadow-lg flex items-center justify-center relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="relative z-10 text-center text-white">
          <div className="text-xs sm:text-sm md:text-base font-semibold mb-0.5 sm:mb-1">
            🎵 Реклама
          </div>
          <div className="text-[10px] sm:text-xs md:text-sm opacity-90 mb-1 sm:mb-2">
            Ваша реклама здесь
          </div>
          <a
            ...
            className="inline-flex items-center gap-1 bg-green-500 hover:bg-green-600 text-white text-[10px] sm:text-xs px-2 sm:px-3 py-0.5 sm:py-1 rounded-full transition-colors"
          >
            📱 WhatsApp
          </a>
        </div>
